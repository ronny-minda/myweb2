...
export const HEader = styled.header`
    ...
    @media (max-width: 750px) {
        ...
        nav {
            ...
            background-image: linear-gradient(to left top, #2767d1, #2058b5, #1a4a9a, #133b80, #0c2e67);
            height: 100vh;
            width: 100vw;
